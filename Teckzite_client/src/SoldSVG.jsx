  ...
  return (
    <div style={{
      ...
      <svg width="154" height="154">
        ...
        <text dominantBaseline="middle" textAnchor="middle" x="50%" y="50%" fontFamily="Manrope3-ExtraBold, Manrope3" fontSize="25" fontWeight="600" fill="none" stroke="#C8102E" strokeWidth="2">
          Sold by {team}
        </text>
        <text>
